...
syn match soulKeyword '\(\.\|:\)\@<!\<\(import\|open\|alias\|using\|as\|end\|match\|with\|cond\|module\|type\|class\|struct\)\>:\@!'
...
syn match soulAtom '\v[A-Z]\w*!?' contains=soulModule
syn match soulModule contained '\<[A-Z]\w*\>\%(\.\)\@='
syn match soulKeywordAtom '\v_?:_?[a-z]\w*\??'
syn match soulKeywordAtom '\v_?[a-z]\w*\??:'
...
hi def link soulAtom Label
hi def link soulKeywordAtom Function
